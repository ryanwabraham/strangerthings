...
function playTitleSequence() {
  ...
  setTimeout(() => {
    ...
    introText.innerHTML = `
    Created by <a href="http://ryanabraham.net">Ryan Abraham</a>.
    <br /> See the code on
    <a href="https://github.com/ryanwabraham/strangerthings">Github</a>.
    `;
    moveLetter({
      id: 'intro',
      offsetX: 0,
